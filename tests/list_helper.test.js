...
describe('blog with the maximum likes', () => {
...
describe('author with max likes', () => {
    ...
    test('total number likes of the author', () => {
        ...
        expect(result).toEqual(authorWithMaxLikes)
    })
})